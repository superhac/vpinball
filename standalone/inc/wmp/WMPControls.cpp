...
{
    *pdCurrentPosition = m_pCore->m_pps->GetMusicPosition();
...
STDMETHODIMP WMPControls::put_currentPosition(double pdCurrentPosition)
{
    ...
    m_pCore->m_pps->SetMusicPosition(pdCurrentPosition);
